...
export default function CollectionArrivedScreen({ onOk, onRetry }: Props) {
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f5f2] px-5 pt-12 pb-8">
      <div className="flex-1 flex flex-col items-center justify-center gap-6">
        ...
        <div className="bg-white rounded-2xl px-6 py-4 border border-gray-100 shadow-sm w-full max-w-xs">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-medium text-gray-700">수거 로봇 대기 중</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-6">
        ...
        >
          ...
          <span className="text-xs text-gray-300">수거 시작</span>
        </button>
      </div>
    </div>
  )
