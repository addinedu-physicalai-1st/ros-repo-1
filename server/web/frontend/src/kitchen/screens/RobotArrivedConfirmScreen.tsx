...
export default function RobotArrivedConfirmScreen({ menuName, onArrived, onNotArrived }: Props) {
  return (
    <div className="flex flex-col items-center justify-center flex-1 gap-8 px-6 py-12">
      ...
      <div className="text-center">
        ...
        {menuName && (
          <p className="text-sm mt-1 font-medium" style={{ color: '#a0aec0' }}>{menuName}</p>
        )}
        <p className="text-sm mt-2" style={{ color: '#a0aec0' }}>
          로봇이 주방에 도착했다고 보고되었습니다
        </p>
