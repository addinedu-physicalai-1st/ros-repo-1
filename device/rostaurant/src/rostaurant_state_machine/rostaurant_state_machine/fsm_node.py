...
from rostaurant_state_machine.srv import TaskRequest
from rostaurant_state_machine.top_fsm import TopFSM, TopState
...
class StateMachineNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('use_function_nodes', False)  # rostaurant_function 패키지 연동 여부
